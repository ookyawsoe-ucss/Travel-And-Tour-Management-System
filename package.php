...
<!--     
    ...
    <section class="ftco-section testimony-section" style="background-image: url('images/bg.jpg');" >
      <div class="container">
          ...
          <div class="col-md-12">
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              ...
              <div class="car-wrap ftco-animate">
                ...
                <div class="text p-4 text-center bg-white" >
                  <h2 class="mb-0"><a href="#"> Chanung</a></h2>
              ...
              <div class="car-wrap ftco-animate">
                ...
                <div class="text p-4 text-center bg-white" >
                  <h2 class="mb-0"><a href="#"> thar</a></h2>
                  <span>ငွေဆောင်အပန်းဖြေစခန်း</span>
                  <p class="d-flex mb-0 d-block"><a href="#" class="btn btn-black btn-outline-black mr-1">Book now</a> <a href="#" class="btn btn-black btn-outline-black ml-1">Details</a></p>
                </div>
              </div>
              <div class="car-wrap ftco-animate">
                ...
                <div class="text p-4 text-center bg-white" >
                  <h2 class="mb-0"><a href="#"> Kyaw Gyi</a></h2>
                  <span>ငွေဆောင်အပန်းဖြေစခန်း</span>
                  <p class="d-flex mb-0 d-block"><a href="#" class="btn btn-black btn-outline-black mr-1">Book now</a> <a href="#" class="btn btn-black btn-outline-black ml-1">Details</a></p>
                </div>
              </div>
              <div class="car-wrap ftco-animate">
                ...
                <div class="text p-4 text-center bg-white" >
                  <h2 class="mb-0"><a href="#"> Kyaw Kyaw</a></h2>
                  <span>ငွေဆောင်အပန်းဖြေစခန်း</span>
                  <p class="d-flex mb-0 d-block"><a href="#" class="btn btn-black btn-outline-black mr-1">Book now</a> <a href="#" class="btn btn-black btn-outline-black ml-1">Details</a></p>
                </div>
              </div>
